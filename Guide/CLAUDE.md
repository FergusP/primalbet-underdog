...
_This file is automatically loaded by Claude when working in this directory_
...
_Updated for Aurelius Colosseum monster combat system. The game features **escalating jackpots** with **verifiable combat** where every failed attempt makes the prize pool bigger and the next person's victory more valuable!_
